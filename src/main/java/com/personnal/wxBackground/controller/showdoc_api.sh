...
# 
api_key="b99cf82ccb309d7d9dc0b23e68eae78c602415753" 			#api_key
api_token="e01d372f87c8e1bdacf459a2439be9a2741488608" 	#api_token
url="https://121.5.177.166:8888//server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.com.cn的不需要修改，使用私有版的请修改
#
#
#
#
