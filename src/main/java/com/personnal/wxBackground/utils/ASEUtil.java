...
public class ASEUtil {
    ...
    public static byte[] encrypt(String plainBytes, String key) throws Exception {
        // 生成密钥对象
        ...
        // 加密数据, 返回密文
        byte[] cipherBytes = cipher.doFinal(plainBytes.getBytes(StandardCharsets.UTF_8));
